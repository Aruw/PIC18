...
O objetivo é acionar o motor apenas quando os botões S1 e S2 forem pressionados
simultaneamente, com um delay de no máximo 250 ms entre um botão e o outro.
Sinaliza tentativa de burlar o sistema com um alarme sonoro. 
Realiza o acionamento do motor por 5 segundos, podendo ser interrompido
